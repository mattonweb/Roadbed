...
/// <summary>
/// Base for sync CRUDAL ("crud-al") services. Six CRUDAL operations delegate to
/// the repository. Exists and Upsert are composed from repository primitives.
/// </summary>
/// <typeparam name="TEntity">Type of entity.</typeparam>
/// <typeparam name="TId">Data type for the identifier.</typeparam>
public class BaseSyncCrudalService<TEntity, TId>
    : BaseClassWithLogging,
      ISyncCrudalService<TEntity, TId>
    where TEntity : IEntity<TId>
{
    #region Private Fields

    private readonly ISyncCrudalRepository<TEntity, TId> _repository;
    ...
    protected BaseSyncCrudalService(
        ISyncCrudalRepository<TEntity, TId> repository,
        ILogger logger)
        : base(logger)
    {
    ...
    /// </summary>
    protected ISyncCrudalRepository<TEntity, TId> Repository => this._repository;
