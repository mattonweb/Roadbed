...
/// <summary>
/// Base for async CRUDAL ("crud-al") services. Six CRUDAL operations delegate to
/// the repository. Exists and Upsert are composed from repository primitives.
/// </summary>
/// <typeparam name="TEntity">Type of entity.</typeparam>
/// <typeparam name="TId">Data type for the identifier.</typeparam>
public class BaseAsyncCrudalService<TEntity, TId>
    : BaseClassWithLogging,
      IAsyncCrudalService<TEntity, TId>
    where TEntity : IEntity<TId>
{
    #region Private Fields

    private readonly IAsyncCrudalRepository<TEntity, TId> _repository;
    ...
    protected BaseAsyncCrudalService(
        IAsyncCrudalRepository<TEntity, TId> repository,
        ILogger logger)
        : base(logger)
    {
    ...
    /// </summary>
    protected IAsyncCrudalRepository<TEntity, TId> Repository => this._repository;
