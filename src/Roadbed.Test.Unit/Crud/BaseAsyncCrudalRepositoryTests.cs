...
/// <see cref="BaseAsyncCrudalRepository{TEntity, TId}"/> abstract class.
/// </summary>
[TestClass]
public class BaseAsyncCrudalRepositoryTests
{
    ...
    public void Constructor_NoParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudalRepository();
    ...
    public void Constructor_WithLogger_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudalRepository(logger);
    ...
    /// <summary>
    /// Unit test to verify that instance implements IAsyncCrudalRepository interface.
    /// </summary>
    [TestMethod]
    public void Instance_TypeCheck_ImplementsIAsyncCrudalRepository()
    {
        // Arrange (Given)
        ...
        // Assert (Then)
        Assert.IsInstanceOfType<IAsyncCrudalRepository<TestEntityRecord, long>>(
            instance,
            "Instance should implement IAsyncCrudalRepository<TestEntityRecord, long>.");
    }
    ...
    /// <summary>
    /// Concrete stub for testing the abstract BaseAsyncCrudalRepository.
    /// </summary>
    private sealed class StubAsyncCrudalRepository
        : BaseAsyncCrudalRepository<TestEntityRecord, long>
    {
        ...
        public StubAsyncCrudalRepository()
            : base()
        {
        }

        public StubAsyncCrudalRepository(ILogger logger)
            : base(logger)
        {
        }
