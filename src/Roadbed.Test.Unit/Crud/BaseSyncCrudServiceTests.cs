...
/// </summary>
[TestClass]
public class BaseSyncCrudServiceTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubSyncCrudService(repository, logger);
    ...
    {
        // Arrange (Given)
        ISyncCrudRepository<TestEntityRecord, long>? nullRepository = null;
        ILogger logger = NullLogger.Instance;
        ...
        try
        {
            new StubSyncCrudService(nullRepository!, logger);
        }
    ...
    public void Repository_Getter_ReturnsInjectedRepository()
    {
        ...
        // Act (When)
        ISyncCrudRepository<TestEntityRecord, long> result =
    ...
    /// <summary>
    /// Concrete subclass for testing the BaseSyncCrudService base class.
    /// Exposes the protected constructor and Repository property.
    /// </summary>
    private sealed class StubSyncCrudService
        : BaseSyncCrudService<TestEntityRecord, long>
    {
        public StubSyncCrudService(
            ISyncCrudRepository<TestEntityRecord, long> repository,
            ILogger logger)
            : base(repository, logger)
        {
        }

        public ISyncCrudRepository<TestEntityRecord, long> ExposedRepository
            => this.Repository;
    }
