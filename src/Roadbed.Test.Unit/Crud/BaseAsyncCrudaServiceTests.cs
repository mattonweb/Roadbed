...
/// </summary>
[TestClass]
public class BaseAsyncCrudaServiceTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudaService(repository, logger);
    ...
    {
        // Arrange (Given)
        IAsyncCrudaRepository<TestEntityRecord, long>? nullRepository = null;
        ILogger logger = NullLogger.Instance;
        ...
        try
        {
            new StubAsyncCrudaService(nullRepository!, logger);
        }
    ...
    public void Repository_Getter_ReturnsInjectedRepository()
    {
        ...
        // Act (When)
        IAsyncCrudaRepository<TestEntityRecord, long> result =
    ...
    /// <summary>
    /// Concrete subclass for testing the BaseAsyncCrudaService base class.
    /// Exposes the protected constructor and Repository property.
    /// </summary>
    private sealed class StubAsyncCrudaService
        : BaseAsyncCrudaService<TestEntityRecord, long>
    {
        public StubAsyncCrudaService(
            IAsyncCrudaRepository<TestEntityRecord, long> repository,
            ILogger logger)
            : base(repository, logger)
        {
        }

        public IAsyncCrudaRepository<TestEntityRecord, long> ExposedRepository
            => this.Repository;
    }
