...
/// <see cref="BaseAsyncCrudlService{TEntity, TId}"/> class.
/// </summary>
[TestClass]
public class BaseAsyncCrudlServiceTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudlService(repository, logger);
    ...
    {
        // Arrange (Given)
        IAsyncCrudlRepository<TestEntityRecord, long>? nullRepository = null;
        ILogger logger = NullLogger.Instance;
        ...
        try
        {
            new StubAsyncCrudlService(nullRepository!, logger);
        }
    ...
    public void Repository_Getter_ReturnsInjectedRepository()
    {
        ...
        // Act (When)
        IAsyncCrudlRepository<TestEntityRecord, long> result =
    ...
    /// <summary>
    /// Concrete subclass for testing the BaseAsyncCrudlService base class.
    /// Exposes the protected constructor and Repository property.
    /// </summary>
    private sealed class StubAsyncCrudlService
        : BaseAsyncCrudlService<TestEntityRecord, long>
    {
        public StubAsyncCrudlService(
            IAsyncCrudlRepository<TestEntityRecord, long> repository,
            ILogger logger)
            : base(repository, logger)
        {
        }

        public IAsyncCrudlRepository<TestEntityRecord, long> ExposedRepository
            => this.Repository;
    }
