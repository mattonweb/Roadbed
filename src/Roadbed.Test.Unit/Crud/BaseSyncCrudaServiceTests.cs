...
/// </summary>
[TestClass]
public class BaseSyncCrudaServiceTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubSyncCrudaService(repository, logger);
    ...
    {
        // Arrange (Given)
        ISyncCrudaRepository<TestEntityRecord, long>? nullRepository = null;
        ILogger logger = NullLogger.Instance;
        ...
        try
        {
            new StubSyncCrudaService(nullRepository!, logger);
        }
    ...
    public void Repository_Getter_ReturnsInjectedRepository()
    {
        ...
        // Act (When)
        ISyncCrudaRepository<TestEntityRecord, long> result =
    ...
    /// <summary>
    /// Concrete subclass for testing the BaseSyncCrudaService base class.
    /// Exposes the protected constructor and Repository property.
    /// </summary>
    private sealed class StubSyncCrudaService
        : BaseSyncCrudaService<TestEntityRecord, long>
    {
        public StubSyncCrudaService(
            ISyncCrudaRepository<TestEntityRecord, long> repository,
            ILogger logger)
            : base(repository, logger)
        {
        }

        public ISyncCrudaRepository<TestEntityRecord, long> ExposedRepository
            => this.Repository;
    }
