...
/// <see cref="BaseSyncCrudalService{TEntity, TId}"/> class.
/// </summary>
[TestClass]
public class BaseSyncCrudalServiceTests
{
    ...
    public void Constructor_ValidParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubSyncCrudalService(repository, logger);
    ...
    {
        // Arrange (Given)
        ISyncCrudalRepository<TestEntityRecord, long>? nullRepository = null;
        ILogger logger = NullLogger.Instance;
        ...
        try
        {
            new StubSyncCrudalService(nullRepository!, logger);
        }
    ...
    /// <summary>
    /// Unit test to verify that instance implements ISyncCrudalService interface.
    /// </summary>
    [TestMethod]
    public void Instance_TypeCheck_ImplementsISyncCrudalService()
    {
        // Arrange (Given)
        var repository = new MockSyncRepository();
        ILogger logger = NullLogger.Instance;
        ...
        // Assert (Then)
        Assert.IsInstanceOfType<ISyncCrudalService<TestEntityRecord, long>>(
            instance,
            "Instance should implement ISyncCrudalService<TestEntityRecord, long>.");
    }

    /// <summary>
    /// Unit test to verify that instance implements ISyncCrudaService interface.
    /// </summary>
    [TestMethod]
    public void Instance_TypeCheck_ImplementsISyncCrudaService()
    {
        // Arrange (Given)
        var repository = new MockSyncRepository();
        ILogger logger = NullLogger.Instance;
        ...
        // Assert (Then)
        Assert.IsInstanceOfType<ISyncCrudaService<TestEntityRecord, long>>(
            instance,
            "Instance should implement ISyncCrudaService<TestEntityRecord, long>.");
    }
    ...
    public void Repository_Getter_ReturnsInjectedRepository()
    {
        ...
        // Act (When)
        ISyncCrudalRepository<TestEntityRecord, long> result =
    ...
    /// <summary>
    /// Unit test to verify that Archive delegates to the repository.
    /// </summary>
    [TestMethod]
    public void Archive_ValidId_DelegatesToRepository()
    {
        // Arrange (Given)
        var expectedEntity = new TestEntityRecord { Id = 1, Name = "Archived" };
        var repository = new MockSyncRepository();
        repository.OnArchive = (id) => expectedEntity;
        ...
        Assert.AreSame(
            expectedEntity,
            result,
            "Archive should return the entity from the repository.");
        Assert.AreEqual(
            1,
            repository.ArchiveCallCount,
            "Archive should delegate to the repository exactly once.");
    }
    ...
    public void Archive_ValidId_CapturesIdentifier()
    {
        ...
        Assert.AreEqual(
            ...
            "Archive should pass the correct identifier to the repository.");
    }
    ...
    /// <summary>
    /// Concrete subclass for testing the BaseSyncCrudalService base class.
    /// Exposes the protected constructor and Repository property.
    /// </summary>
    private sealed class StubSyncCrudalService
        : BaseSyncCrudalService<TestEntityRecord, long>
    {
        public StubSyncCrudalService(
            ISyncCrudalRepository<TestEntityRecord, long> repository,
            ILogger logger)
            : base(repository, logger)
        {
        }

        public ISyncCrudalRepository<TestEntityRecord, long> ExposedRepository
            => this.Repository;
    }
