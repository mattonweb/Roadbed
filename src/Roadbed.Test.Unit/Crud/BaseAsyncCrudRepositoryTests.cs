...
/// <see cref="BaseAsyncCrudRepository{TEntity, TId}"/> abstract class.
/// </summary>
[TestClass]
public class BaseAsyncCrudRepositoryTests
{
    ...
    public void Constructor_NoParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudRepository();
    ...
    public void Constructor_WithLogger_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubAsyncCrudRepository(logger);
    ...
    /// <summary>
    /// Concrete stub for testing the abstract BaseAsyncCrudRepository.
    /// </summary>
    private sealed class StubAsyncCrudRepository
        : BaseAsyncCrudRepository<TestEntityRecord, long>
    {
        ...
        public StubAsyncCrudRepository()
            : base()
        {
        }

        public StubAsyncCrudRepository(ILogger logger)
            : base(logger)
        {
        }
