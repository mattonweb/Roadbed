...
/// <see cref="BaseSyncCrudalRepository{TEntity, TId}"/> abstract class.
/// </summary>
[TestClass]
public class BaseSyncCrudalRepositoryTests
{
    ...
    public void Constructor_NoParameters_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubSyncCrudalRepository();
    ...
    public void Constructor_WithLogger_CreatesInstance()
    {
        ...
        // Act (When)
        var instance = new StubSyncCrudalRepository(logger);
    ...
    /// <summary>
    /// Unit test to verify that instance implements ISyncCrudalRepository interface.
    /// </summary>
    [TestMethod]
    public void Instance_TypeCheck_ImplementsISyncCrudalRepository()
    {
        // Arrange (Given)
        ...
        // Assert (Then)
        Assert.IsInstanceOfType<ISyncCrudalRepository<TestEntityRecord, long>>(
            instance,
            "Instance should implement ISyncCrudalRepository<TestEntityRecord, long>.");
    }
    ...
    /// <summary>
    /// Concrete stub for testing the abstract BaseSyncCrudalRepository.
    /// </summary>
    private sealed class StubSyncCrudalRepository
        : BaseSyncCrudalRepository<TestEntityRecord, long>
    {
        ...
        public StubSyncCrudalRepository()
            : base()
        {
        }

        public StubSyncCrudalRepository(ILogger logger)
            : base(logger)
        {
        }
