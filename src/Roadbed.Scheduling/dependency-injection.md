...
This is related to https://www.nuget.org/packages/Quartz.Extensions.DependencyInjection.

That project provides the following example on how to install and configure Quartz.NET.
